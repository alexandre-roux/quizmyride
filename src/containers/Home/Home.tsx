...
const Home = ({numberOfQuestions, setDisplayQuiz, setNumberOfGoodAnswers}: HomeProps) => {
    ...
    return (
        <div className={`${styles['home-container']} ${styles['fade-in']} ${isFadingOut ? styles['fade-out'] : ''}`}>
            ...
            <p className={styles['intro-text']}>
                ...
                <br/>
                <br/>
                This quiz will give you a series of {numberOfQuestions} bus images, and you have to pick the correct
                model from
                four options.
                <br/>
