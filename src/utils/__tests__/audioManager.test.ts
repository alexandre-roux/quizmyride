...
describe('audioManager', () => {
  ...
  it('getAudio caches instances per key', () => {
    ...
    expect(a1).toBeInstanceOf(Audio as any)
  })
  ...
  it('warmUp plays and pauses once (unlocked)', async () => {
    const playSpy = vi.spyOn(Audio.prototype as any, 'play')
    const pauseSpy = vi.spyOn(Audio.prototype as any, 'pause')
